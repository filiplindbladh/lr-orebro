<template>
  <div>
      <lrTabs id="lrTabs">
        <lrTab name="Redovisning" :selected="true">
          <div id="tabContent" class="tabContent section">
            <h3>Redovisning</h3>
...
import lrTab from '@/components/lrTab.vue'
import lrTabs from '@/components/lrTabs.vue'
